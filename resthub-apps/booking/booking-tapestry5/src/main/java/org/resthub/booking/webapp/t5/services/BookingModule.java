 ...
 */
@SubModule({ BookingSecurityModule.class, ResthubModule.class, BookingJPAModule.class })
public class BookingModule {
    ...
    public static void contributeApplicationDefaults(MappedConfiguration<String, String> configuration) {
        ...
        configuration.add("spring-security.anonymous.key", "spring_security_anonymous");
