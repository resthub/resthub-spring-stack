...
public class DelegateDatabaseDataSourceConnection implements IDatabaseConnection {
	...
	public DelegateDatabaseDataSourceConnection(DataSource dataSource, boolean autoDetectDbProduct) throws SQLException, DatabaseUnitException {
