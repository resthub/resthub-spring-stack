...
/**
 * Provide configuration for Tapestry5 resthub integration module :
 * contributions of services, behaviours, configuration parameters, libraries,
 * etc.
 * 
 * Basically, only provide inclusion of all others nested resthub Tapestry5 sub
 * modules
 * 
 * @author bmeurant <Baptiste Meurant>
 * 
 */
@SubModule({ ResthubValidationModule.class, ResthubJPAModule.class, ResthubComponentsModule.class })
