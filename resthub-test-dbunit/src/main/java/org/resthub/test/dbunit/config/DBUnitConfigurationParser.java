...
public class DBUnitConfigurationParser extends AbstractSingleBeanDefinitionParser {
    ...
    protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        BeanDefinitionBuilder databaseConnectionBuilder = BeanDefinitionBuilder
        ...
        String databaseConnectionBeanName = resolveId(element, databaseConnectionBean, parserContext)
                + "-databaseConnection";
        ...
        BeanDefinitionBuilder dbTesterBeanDefinitionBuilder = BeanDefinitionBuilder
