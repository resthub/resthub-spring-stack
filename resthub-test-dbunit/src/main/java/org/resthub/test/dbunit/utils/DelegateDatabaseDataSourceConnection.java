...
public class DelegateDatabaseDataSourceConnection implements IDatabaseConnection {

    private Logger logger = LoggerFactory.getLogger(DelegateDatabaseDataSourceConnection.class);
    ...
    public DelegateDatabaseDataSourceConnection(DataSource dataSource) throws SQLException, DatabaseUnitException {
        this(dataSource, null);
    }

    public DelegateDatabaseDataSourceConnection(DataSource dataSource, String schema) throws SQLException,
    ...
    public ITable createTable(String resultName, PreparedStatement preparedStatement) throws DataSetException,
            SQLException {
