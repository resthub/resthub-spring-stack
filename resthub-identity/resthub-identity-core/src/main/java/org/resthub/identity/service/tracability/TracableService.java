...
/**
 * This interface defines required stuff to allow third-party systems to track modifications
...
public interface TracableService {
	 ...
	 * Uneffective if the listener was already registered.
	 *  
	 ...
	 * Uneffective if the listener was not registered.
	 *  
	 * @param listener The added listener.
	 */
