...
public class UserControllerWebTest extends AbstractControllerWebTest<User, Long> {
    ...
    public void shouldAddRoleToUser() throws Exception {
        ...
        String userWithRole = resource().path("user/login/" + u.getLogin()).accept(MediaType.APPLICATION_JSON)
                .get(String.class);
    ...
    public void shouldGetRolesFromUsers() throws Exception {
        ...
        String user1Roles = resource().path("user/name/" + u1.getLogin() + "/roles").accept(MediaType.APPLICATION_JSON)
                .get(String.class);
        String user2Roles = resource().path("user/name/" + u2.getLogin() + "/roles").accept(MediaType.APPLICATION_JSON)
                .get(String.class);
        String user3Roles = resource().path("user/name/" + u3.getLogin() + "/roles").accept(MediaType.APPLICATION_JSON)
                .get(String.class);
        String user4Roles = resource().path("user/name/" + u4.getLogin() + "/roles").accept(MediaType.APPLICATION_JSON)
                .get(String.class);
