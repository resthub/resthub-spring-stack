...
/**
 * Service that manage ACLs. An ACL (Access Control Layer) is the combination of
 * a domain object, a permission and a user's id. TODO
 */
...
public interface AclService extends TracableService {
    ...
    enum AclServiceChange {
        /**
         * Group creation. Arguments : 1- Id of the concerned domainObject 2- Id
         * of the concerned user 3- Added permission
         */
        ACL_CREATION,
        /**
         * Group deletion. Arguments : 1- Id of the concerned domainObject 2- Id
         * of the concerned user 3- Added permission
         */
        ACL_DELETION
    };
    ...
    /**
     * Saves an ACL (or update the existing one) for a specified owner on a
     * specified resource.
     * 
     * @param domainObject
     *            The resource concerned.
     * @param domainObjectId
     *            The concerned resource Id.
     * @param userId
     *            Id of the user.
     * @param permission
     *            Permission added to this owner on this resource.
     */
     ...
     *            Id of the user.
     * @param permission
     *            Permission removed from this owner on this resource.
     * 
     * @throws NotFoundException
     *             If the permission is not associated to this owner on
     */
     ...
     * @param domainObjectId
     *            The concerned resource Id.
     * @return ACL for this resource, containing all permissions of all related
     *         owner.
     */
     ...
     *            Id of the user.
     * @param permissions
     *            List of permissions added to this owner on this resource.
     */
     ...
     *            Id of the user.
     * @param permissions
     *            List of permissions removed from this owner on this resource.
     * 
     * @throws NotFoundException
     *             If the permission is not associated to this owner on
     */
     ...
     * 
     * @param domainObject
     *            object to locate an {@link Acl}
     * @param recipient
     *            the security identities for which {@link Acl} information is
     *            required
     * @param permissionName
     *            Permission Name removed from this owner on this resource.
     * 
     * @throws NotFoundException
     *             If the permission is not associated
     */
     ...
     *            required
     * @param mask
     *            a permission mask, it's a integer value
     * 
     * @throws NotFoundException
     *             If the permission is not associated
     */
     ...
     * @param recipient
     *            the security identities for which {@link Acl} information is
     *            required (may be <tt>null</tt> to denote all entries)
     * @param permission
     *            a given permission
     */
     ...
     * 
     * @param domainObject
     *            object to locate an {@link Acl} for
     * @param recipient
     *            the security identities for which {@link Acl} information is
     *            required
     * 
     * @param permissionName
     *            a given permission. The effective permission must be build
     *            using <code>ConfigurablePermissionFactory</code> class
     * 
     */
