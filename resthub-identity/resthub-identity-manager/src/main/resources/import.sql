...
INSERT INTO USER (ID, FIRSTNAME, LASTNAME, EMAIL, LOGIN, PASSWORD) VALUES (3, 'test', 'ing', 'test@atosorigin.com', 'test', 'lvxWgeRR8QOakoGHnYAdxmW1ujQaauua');
INSERT INTO PERMISSIONSOWNER_GROUP ( PERMISSIONSOWNER_ID , GROUPS_ID ) VALUES ( 3, 1 );


INSERT INTO PERMISSIONSOWNER (ID) VALUES (4);
INSERT INTO USER (ID, FIRSTNAME, LASTNAME, EMAIL, LOGIN, PASSWORD) VALUES (4, 'alex', 'synclar', 'user1@atosorigin.com', 'admin', 'nwCxqV005XMHxW4oPNWmZE5MNXqH31sJ');
