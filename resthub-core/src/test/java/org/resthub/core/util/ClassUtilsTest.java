...
public class ClassUtilsTest {
	...
	public void testGetGenericTypeFromBean() {
		...
		Assert.assertEquals("Base class generic type", SampleResource.class, ClassUtils.getGenericTypeFromBean(new SampleResourceArrayList()));
	}
	
	class SampleResourceArrayList extends ArrayList<SampleResource> {
