...
/**
 * This kind of exception is thrown when error occur during import or export
 * resources
 * 
 * @author pastis
 * 
 */
public class ImportExportResourceException extends ResthubException {
	 ...
	 * Default constructor
	 */
	public ImportExportResourceException() {
		super();
	}

	public ImportExportResourceException(String message) {
		super(message);
	}

	public ImportExportResourceException(String message, Throwable throwable) {
