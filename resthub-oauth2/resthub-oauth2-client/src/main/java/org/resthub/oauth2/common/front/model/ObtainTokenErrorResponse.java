...
/**
 * Error response for of the token obtention end-point, as described in the
 * Oauth 2 specification (Section 4.3).
 */
@XmlRootElement
...
public class ObtainTokenErrorResponse implements Serializable {
    ...
    /**
     * A human-readable text providing additional information, used to assist in
     ...
     * error, used to provide the end-user with additional information about the
     * error.
     */
     ...
     * 
     * @param exc
     *            Exception source of this error response.
     */
    ...
    public String toString() {
        return new StringBuilder("[ObtainTokenErrorResponse] error: ").append(error).append(" description: ")
