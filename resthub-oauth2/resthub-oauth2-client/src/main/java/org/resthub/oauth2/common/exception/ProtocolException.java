...
/**
 * OAuth v2 protocl exception, used in service layer to indicates protocol
 * errors.
 */
public class ProtocolException extends RuntimeException {
    ...
    public enum Error {
        /**
         * Used when responding to a request that do not have access token. No
         * Error code or explanation must be returned.
         */
        UNAUTHORIZED_REQUEST(null, Status.UNAUTHORIZED),

        /**
         * The access token provided is invalid. Used when receiving an expired
         * token which cannot be refreshed to indicate to the client that a new
         * authorization is necessary.
         */
        INVALID_TOKEN("invalid_token", Status.UNAUTHORIZED),

        /**
         * The access token provided has expired. Used only this error code when
         * the client is expected to be able to handle the response and request
         * a new access token using the refresh token issued with the expired
         * access token.
         */
        EXPIRED_TOKEN("expired_token", Status.UNAUTHORIZED),

        /**
         * The request is missing a required parameter, includes an unknown
         ...
         * authenticate, or the client provided multiple client credentials.
         */
        ...
        /**
         * The requested response type is not supported by the authorization
         * server.
         */
