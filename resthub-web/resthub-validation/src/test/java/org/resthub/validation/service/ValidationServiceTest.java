...
import org.resthub.validation.model.*;
...
@ActiveProfiles("resthub-validation")
public class ValidationServiceTest extends AbstractTest {
    ...
    public void testNotNullValidationModelFromExistingClassName() {
        ...
        try {
            modelConstraint =
                    this.validationService.getConstraintsForClassName("org.resthub.validation.model.NotNullValidationModel");
    ...
    private void validateNotNullValidationModel(ModelConstraint modelConstraint) {
        ...
        Assertions.assertThat(modelConstraint.getModelRef()).isNotNull().isEqualTo("org.resthub.validation.model.NotNullValidationModel");
    ...
    public void testCompleteValidationModel() {
        ...
        Assertions.assertThat(modelConstraint).isNotNull();
        Assertions.assertThat(modelConstraint.getModelRef()).isNotNull().isEqualTo("org.resthub.validation.model.CompleteValidationModel");
        Assertions.assertThat(modelConstraint.getConstraints()).isNotNull().isNotEmpty().hasSize(13);
    ...
    public void testCombinedValidationModel() {
        ...
        Assertions.assertThat(modelConstraint).isNotNull();
        Assertions.assertThat(modelConstraint.getModelRef()).isNotNull().isEqualTo("org.resthub.validation.model.CombinedValidationModel");
    ...
    public void testInheritanceAndCompositionValidationModel() {
        ...
        Assertions.assertThat(modelConstraint).isNotNull();
        Assertions.assertThat(modelConstraint.getModelRef()).isNotNull().isEqualTo("org.resthub.validation.model.AModel");
        ...
        Assertions.assertThat(modelConstraint.getConstraints().get("field5").get(1).getType()).isEqualTo("Cascaded");
        ...
        Assertions.assertThat(modelConstraint.getConstraints().get("field5").get(1).getAttributes().get("model")).isNotNull().isEqualTo("org.resthub.validation.model.BModel");

        modelConstraint =
                this.validationService.getConstraintsForClass(BModel.class);

        Assertions.assertThat(modelConstraint).isNotNull();
        Assertions.assertThat(modelConstraint.getModelRef()).isNotNull().isEqualTo("org.resthub.validation.model.BModel");
        Assertions.assertThat(modelConstraint.getConstraints()).isNotNull().isNotEmpty().hasSize(2);
