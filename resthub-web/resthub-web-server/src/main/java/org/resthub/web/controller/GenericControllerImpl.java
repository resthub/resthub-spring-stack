...
public abstract class GenericControllerImpl<T, ID extends Serializable, S extends GenericService<T, ID>> implements GenericController<T, ID> {
	...
	/* (non-Javadoc)
	 * @see org.resthub.web.controller.GenericController#getEntities(java.lang.Integer, java.lang.Integer)
	 */
	@Override
	@GET
	public PageResponse<T> findAll(
